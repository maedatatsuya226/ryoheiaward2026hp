 ...
 *
 * 現方針:受賞者は開催前に発表(事前告知)。
 * 方針が「授賞式当日に発表」へ変わった場合は、ここの文言を
 * 「受賞者は当日発表」「当日、ここから光ります。」等に書き換えるだけでよい。
 */
export const awardeesNotice = {
  ...
  footer: "受賞者は近日発表します",
  /** 受賞者一覧ページの年度カード用 */
  yearCard: "受賞者は近日発表します",
  /** 導線セクションの見出し(「光」の字はgoldtextで強調表示される) */
  teaserTitle: "まもなく、ここから光ります。",
  /** 導線セクションの本文 */
  teaserBody: "受賞者は開催に先立ちご紹介します。発表の日を、どうぞお楽しみに。",
  /** 導線セクションの添え書き */
  teaserNote: "受賞者は近日発表 — 発表後、このページでご紹介します",
  /** 受賞者ページ(発表前)の本文 */
  pageLead: "受賞者は開催に先立ち発表します。発表の後、このページで受賞者の行動や思いをご紹介します。",
  /** 開催概要の「受賞者」欄 */
  overviewValue: "近日発表",
};
